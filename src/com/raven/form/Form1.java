...
public class Form1 extends javax.swing.JPanel {
    ...
    public Form1() {
        ...
        gaugeChart2.setValueWithAnimation(85);
        gaugeChart3.setValueWithAnimation(75);
        init();
    }

    private void init() {
        barChart.addLegend("Australia", new Color(12, 84, 175), new Color(0, 108, 247));
        barChart.addLegend("Canada", new Color(54, 4, 143), new Color(104, 49, 200));
        barChart.addLegend("Ireland", new Color(5, 125, 0), new Color(95, 209, 69));
        barChart.addLegend("New Zealand", new Color(186, 37, 37), new Color(241, 100, 120));
        barChart.addLegend("United Kingdom", cyan, cyan);
        barChart.addLegend("United States",yellow, yellow);

        barChart.addData(new ModelChart("January", new double[]{500, 200, 80, 89,67,212}));
        barChart.addData(new ModelChart("February", new double[]{600, 750, 90, 150,909,32}));
        barChart.addData(new ModelChart("March", new double[]{200, 350, 460, 900,678,985}));
        barChart.addData(new ModelChart("April", new double[]{480, 150, 750, 700,135,642}));
//        barChart.addData(new ModelChart("May", new double[]{350, 540, 300, 150,67,34}));
//        barChart.addData(new ModelChart("June", new double[]{190, 280, 81, 200,78,89}));
        barChart.start();
        lineChart.addLegend("Australia", new Color(12, 84, 175), new Color(0, 108, 247));
        lineChart.addLegend("Canada", new Color(54, 4, 143), new Color(104, 49, 200));
        lineChart.addLegend("Ireland", new Color(5, 125, 0), new Color(95, 209, 69));
        lineChart.addLegend("New Zealand", new Color(186, 37, 37), new Color(241, 100, 120));
        lineChart.addLegend("United Kingdom", cyan, cyan);
        lineChart.addLegend("United States",yellow, yellow);

        lineChart.addData(new ModelChart("January", new double[]{500, 200, 80, 89,67,212}));
        lineChart.addData(new ModelChart("February", new double[]{600, 750, 90, 150,909,32}));
        lineChart.addData(new ModelChart("March", new double[]{200, 350, 460, 900,678,985}));
        lineChart.addData(new ModelChart("April", new double[]{480, 150, 750, 700,135,642}));
...
//        lineChart.addData(new ModelChart("June", new double[]{190, 280, 81, 200}));
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(104, 1148));
        ...
        panelShadow3.setBackground(new java.awt.Color(30, 30, 30));
        ...
        lineChart.setBackground(new java.awt.Color(30, 30, 30));
        ...
        barChart.setBackground(new java.awt.Color(30, 30, 30));
